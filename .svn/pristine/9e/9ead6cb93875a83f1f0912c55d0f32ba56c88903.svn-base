...
public class XmlOper {
	/*全局变量*/
    private static Logger xmllog = Logger.getLogger(XmlOper.class);
	/**
	 * 构造函数
	 */
	private XmlOper()
	    ...
	    **/
	    public static String getElementValue(Element element)
	    {
	        ...
	        for(int i=0;i<nl.getLength();i++)
	        {
	            ...
	            {            
	            	xmllog.debug(element.getNodeName()+" has a Text Node.");
	                return element.getFirstChild().getNodeValue();
	            }
	        }   
	        xmllog.error(element.getNodeName()+" hasn't a Text Node.");
	        return null;
	    }
	    ...
	    **/
	    public static void setElementValue(Element element,String val)
	    {
	        ...
	        for(int i=0;i<nl.getLength();i++)
	        {
	            ...
	            {            
	                  nd.setNodeValue(val);
	                  xmllog.debug("modify "+element.getNodeName()+"'s node value succe.");
	                  return;
	            }
	        }   
	        xmllog.debug("new "+element.getNodeName()+"'s node value succe.");
...
        * 日期：2015-04-29
	    **/
	    ...
	    {
	    	xmllog.debug("remove "+parent.getNodeName()+"'s children by tagName "+tagName+" begin...");
	        ...
	        for(int i=0;i<nl.getLength();i++)
	        {
	            ...
	            if(nd.getNodeName().equals(tagName))
	            {
	                ...
	                xmllog.debug("remove child '"+nd+"' success.");
	            }
	        }
	        xmllog.debug("remove "+parent.getNodeName()+"'s children by tagName "+tagName+" end.");
	    }
}
