...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    ...
    <div region="north" split="true" style="overflow: hidden; height: 50px; background: #D2E0F2 repeat-x center 50%;
        line-height: 20px;">
         <div style="cursor: pointer; text-align: left;font-weight: bold;">欢迎使用 NetsSmart ver 1.0</div>
   ...
   <!-- <div region="south" style="height: 20px; background: #D2E0F2;">
    ...
    <div region="west" split="true" title="导航菜单" style="width: 210px;overflow:hidden;" icon="icon-redo">
        <div id="menu" class="easyui-accordion" fit="true" border="false">
            <div title="网站模板配置" style="overflow:auto; width:16%;padding: 10px;overflow-x:hidden;background-color: transparent;" icon="icon-edit">
               <div title="网站配置">
                  <!--   <ul>
    ...
    <div id="tabs" class="easyui-tabs" data-options="tools:'#tab-tools'"  fit="true" border="false">
	  ...
	  <div data-options="region:'center',border:false">     
	    <div id="tabs" class="easyui-tabs" data-options="fit:true">  
           <div title="首页" data-options="closable:false" style="overflow: hidden; background:#fff">  
